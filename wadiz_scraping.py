...
def wadiz_scraping(fname = 'wadiz.xlsx'):
    # 엑셀 파일 만들기
    ...
    # 전체 프로젝트 목록 페이지로 이동 (종료된 프로젝트들 마감임박순으로 나열한 페이지)
